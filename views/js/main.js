...
document.addEventListener('DOMContentLoaded', function() {
  //There are at most 7 moving pizza per row. So change cols to 7
  var cols = 7;
  var s = 256;
  //Get Current viewport's height
  var viewPortHeight = Math.max(document.documentElement.clientHeight, window.innerHeight || 0);
  //Every moving pizza row's heith takes 256px. So calculate the real pizza number that actually need to be displayed.
  var rows =  Math.floor(viewPortHeight/s)+1;
